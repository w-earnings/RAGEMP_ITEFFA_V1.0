...
namespace iTeffa.Houses
{
    class Hotel : Script
    {
        private static readonly Plugins.Logs Log = new Plugins.Logs("Hotel");
            ...
            try
            {
                ...
                foreach (var pos in HotelEnters)
                {
                    ...
                    colshape.OnEntityEnterColShape += (s, e) =>
                    {
                        ...
                        catch (Exception ex) { Log.Write("Enter.colshape.OnEntityEnterColShape: " + ex.Message, Plugins.Logs.Type.Error); }
                    };
                    colshape.OnEntityExitColShape += (s, e) =>
                    {
                        ...
                        catch (Exception ex) { Log.Write("Enter.colshape.OnEntityExitColShape: " + ex.Message, Plugins.Logs.Type.Error); }
                    };
                ...
                foreach (var pos in CarsGet)
                {
                    ...
                    colshape.OnEntityEnterColShape += (s, e) =>
                    {
                        ...
                        catch (Exception ex) { Log.Write("CarsGet.colshape.OnEntityEnterColShape: " + ex.Message, Plugins.Logs.Type.Error); }
                    };
                    colshape.OnEntityExitColShape += (s, e) =>
                    {
                        try
                        ...
                        catch (Exception ex) { Log.Write("CarsGet.colshape.OnEntityExitColShape: " + ex.Message, Plugins.Logs.Type.Error); }
                    };
