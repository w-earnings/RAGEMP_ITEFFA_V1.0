...
namespace iTeffa.Finance
{
    class Branch : Script
    {
        private static readonly Plugins.Logs Log = new Plugins.Logs("Bank branches");
            ...
            try
            {
                ...
                for (int i = 0; i < BRANCHs.Count; i++)
                {
                    ...
                    BRANCHCols[i].OnEntityEnterColShape += (s, e) => {
                        ...
                        catch (Exception ex) { Log.Write("BRANCHCols.OnEntityEnterColShape: " + ex.Message, Plugins.Logs.Type.Error); }
                    };
                    BRANCHCols[i].OnEntityExitColShape += (s, e) => {
                        ...
                        catch (Exception ex) { Log.Write("BRANCHCols.OnEntityExitrColShape: " + ex.Message, Plugins.Logs.Type.Error); }
                    };
                }
            }
        ...
        public static void ClientEvent_BRANCHCB(Player player, params object[] args)
        {
            ...
            catch (Exception e) { Log.Write("branchCB: " + e.Message, Plugins.Logs.Type.Error); }
        }
        [RemoteEvent("branch")]
        public static void ClientEvent_BRANCH(Player player, params object[] args)
        {
            ...
            catch (Exception e) { Log.Write("branch: " + e.Message, Plugins.Logs.Type.Error); }
        }
    }
}
