...
namespace iTeffa.Working
{
    ...
    {
        private static readonly Plugins.Logs Log = new Plugins.Logs("WorkManager");
        ...
        public void JobMenu_onEntityEnterColShape(ColShape shape, Player entity)
        {
            ...
            catch (Exception ex) { Log.Write("JobMenu_onEntityEnterColShape: " + ex.Message, Plugins.Logs.Type.Error); }
        }
