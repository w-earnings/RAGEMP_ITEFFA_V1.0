...
namespace iTeffa.Working
{
    ...
    {
        private static readonly Plugins.Logs Log = new Plugins.Logs("GoPostal");
        ...
        private void gp_onEntityEnterColShape(ColShape shape, Player entity)
        {
            ...
            catch (Exception ex) { Log.Write("gp_onEntityEnterColShape: " + ex.Message, Plugins.Logs.Type.Error); }
        }
        private void gp_onEntityExitColShape(ColShape shape, Player entity)
        {
            ...
            catch (Exception ex) { Log.Write("gp_onEntityExitColShape: " + ex.Message, Plugins.Logs.Type.Error); }
        }
