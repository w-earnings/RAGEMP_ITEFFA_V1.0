...
namespace iTeffa.Working
{
    class Taxi : Script
    {
        ...
        private static readonly Plugins.Logs Log = new Plugins.Logs("Taxi");
        ...
        private static void order_onEntityExit(ColShape shape, Player player)
        {
            ...
            catch (Exception ex) { Log.Write("order_onEntityExit: " + ex.Message, Plugins.Logs.Type.Error); }
        }
        ...
        public void onPlayerExitVehicleHandler(Player player, Vehicle vehicle)
        {
            ...
            catch (Exception e) { Log.Write("PlayerExit: " + e.Message, Plugins.Logs.Type.Error); }
        }
