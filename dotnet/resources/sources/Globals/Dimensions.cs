...
namespace iTeffa.Globals
{
    ...
    {
        private static readonly Plugins.Logs Log = new Plugins.Logs("Dimensions");
        ...
        public static void DismissPrivateDimension(Player requester)
        {
            ...
            catch (Exception e) { Log.Write("DismissPrivateDimension: " + e.Message, Plugins.Logs.Type.Error); }
        }
