...
namespace iTeffa.Globals
{
    class Items : Script
    {
        private static readonly Plugins.Logs Log = new Plugins.Logs("Items");
        ...
        public void Event_OnEntityDeleted(Entity entity)
        {
            ...
            {
                Log.Write("Event_OnEntityDeleted: " + e.Message, Plugins.Logs.Type.Error);
            }
        }
        ...
        public static void deleteObject(GTANetworkAPI.Object obj)
        {
            NAPI.Task.Run(() =>
            {
                ...
                {
                    Log.Write("UpdateObject: " + e.Message, Plugins.Logs.Type.Error);
                }
            }, 0);
        }
        ...
        public static void onDrop(Player player, nItem item, dynamic data)
        {
            ...
            catch (Exception e) { Log.Write("onDrop: " + e.Message, Plugins.Logs.Type.Error); }
        }
