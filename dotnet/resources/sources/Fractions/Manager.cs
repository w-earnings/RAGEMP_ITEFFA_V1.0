...
namespace iTeffa.Fractions
{
    ...
    { 
        ...
        public static void onResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(674, FractionSpawns[6], 1.0F, 14, Main.StringToU16("CityHall"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(675, new Vector3(-1304.6462, -560.2332, 33.25491), 1.0F, 14, Main.StringToU16("CityHall"), 255, 0, true, 0);
                ...
                NAPI.Blip.CreateBlip(437, FractionSpawns[1], 0.75F, 52, Main.StringToU16("The Families"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(437, FractionSpawns[2], 0.75F, 58, Main.StringToU16("The Ballas"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(437, FractionSpawns[3], 0.75f, 28, Main.StringToU16("Los Santos Vagos"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(437, FractionSpawns[4], 0.75F, 74, Main.StringToU16("Marabunta Grande"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(437, FractionSpawns[5], 0.75F, 49, Main.StringToU16("Blood Street"), 255, 0, true, 0, 0);
