...
namespace iTeffa.Fractions.Realm
{
    ...
    {
        private static readonly Plugins.Logs Log = new Plugins.Logs("Merryweather");
        ...
        private void mws_OnEntityEnterColShape(ColShape shape, Player entity)
        {
            ...
            catch (Exception e) { Log.Write("mws_OnEntityEnterColShape: " + e.Message, Plugins.Logs.Type.Error); }
        }
        ...
        private void mws_OnEntityExitColShape(ColShape shape, Player entity)
        {
            ...
            catch (Exception e) { Log.Write("mws_OnEntityExitColShape: " + e.Message, Plugins.Logs.Type.Error); }
        }
        ...
        public static void interactPressed(Player player, int interact)
        {
            switch (interact)
            {
                ...
                case 85:
                    ...
                    {
                        Plugins.Notice.Send(player, Plugins.TypeNotice.Error, Plugins.PositionNotice.TopCenter, "Вы не состоите в Merryweather", 3000);
                        return;
                    }
