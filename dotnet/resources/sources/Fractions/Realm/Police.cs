...
namespace iTeffa.Fractions.Realm
{
    class Police : Script
    {
        private static readonly Plugins.Logs Log = new Plugins.Logs("Police");
        ...
        public static void callPolice(Player player, string reason)
        {
            NAPI.Task.Run(() =>
            {
                try
                {
                    ...
                    {
                        Plugins.Notice.Send(player, Plugins.TypeNotice.Error, Plugins.PositionNotice.TopCenter, "Нет полицейских в Вашем районе. Попробуйте позже", 3000);
                        return;
                    }
                    if (player.HasData("NEXTCALL_POLICE") && DateTime.Now < player.GetData<DateTime>("NEXTCALL_POLICE"))
                    {
                        Plugins.Notice.Send(player, Plugins.TypeNotice.Error, Plugins.PositionNotice.TopCenter, "Вы уже вызвали полицию, попробуйте позже", 3000);
                        return;
                    }
        ...
        public static void acceptCall(Player player, Player target)
        {
            try
            {
                ...
                {
                    Plugins.Notice.Send(player, Plugins.TypeNotice.Error, Plugins.PositionNotice.TopCenter, "Игрок не вызывал полицию или этот вызов уже кто-то принял", 3000);
                    return;
                }
        ...
        public static void clearWantedLvl(Player sender, params object[] arguments)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        Plugins.Notice.Send(sender, Plugins.TypeNotice.Error, Plugins.PositionNotice.TopCenter, $"Паспорта с таким номером не существует", 3000);
                        return;
                    }
                ...
                catch
                {
                    ...
                    {
                        Plugins.Notice.Send(sender, Plugins.TypeNotice.Error, Plugins.PositionNotice.TopCenter, $"Игрок не найден", 3000);
                        return;
                    }
            ...
            catch (Exception e) { Log.Write("ClearWantedLvl: " + e.Message, Plugins.Logs.Type.Error); }
        }
        ...
        public static void checkNumber(Player sender, params object[] arguments)
        {
            ...
            catch (Exception e) { Log.Write("checkNumber: " + e.Message, Plugins.Logs.Type.Error); }
        }
        ...
        public static void checkPerson(Player sender, params object[] arguments)
        {
            ...
            catch (Exception e) { Log.Write("checkPerson: " + e.Message, Plugins.Logs.Type.Error); }
        }
        ...
        public static void checkWantedList(Player sender, params object[] arguments)
        {
            ...
            catch (Exception e) { Log.Write("checkWantedList: " + e.Message, Plugins.Logs.Type.Error); }
        }
        ...
        public static void openCopcarmenu(Player sender, params object[] arguments)
        {
            ...
            catch (Exception e) { Log.Write("openCopCarMenu: " + e.Message, Plugins.Logs.Type.Error); }
        }
        ...
        public static void interactPressed(Player player, int interact)
        {
            ...
            switch (interact)
            {
                ...
                case 11:
                    ...
                    else Plugins.Notice.Send(player, Plugins.TypeNotice.Error, Plugins.PositionNotice.TopCenter, $"Вы не сотрудник полиции", 3000);
                    return;
                case 12:
                    if (Main.Players[player].FractionID != 7)
                    {
                ...
                case 42:
                    ...
                    {
                        Plugins.Notice.Send(player, Plugins.TypeNotice.Error, Plugins.PositionNotice.TopCenter, $"У Вас нет ни сумки с деньгами, ни сумки с дрелью", 3000);
                        return;
                    }
                    ...
                    Loggings.Money($"server", $"player({Main.Players[player].UUID})", 200, $"policeAward");
                ...
                case 44:
                    ...
                    Plugins.Notice.Send(player, Plugins.TypeNotice.Success, Plugins.PositionNotice.TopCenter, $"Вы купили лицензию на оружие", 3000);
                ...
                case 59:
                    ...
                    Interface.Dashboard.OpenOut(player, Stocks.fracStocks[7].Weapons, "Склад оружия", 6);
                    return;
                case 66:
                    if (Main.Players[player].FractionID != 7)
                    {
        ...
        public static void callback_policeGuns(Player client, int index)
        {
            try
            {
                switch (index)
                {
                    ...
                    case 5:
                        ...
                        {
                            Plugins.Notice.Send(client, Plugins.TypeNotice.Error, Plugins.PositionNotice.TopCenter, "На складе недостаточно материала", 3000);
                            return;
                        }
            ...
            {
                Log.Write($"Lspdgun: " + e.Message, Plugins.Logs.Type.Error);
            }
        }
