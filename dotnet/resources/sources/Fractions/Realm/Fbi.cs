...
namespace iTeffa.Fractions.Realm
{
    class Fbi : Script
    {
        ...
        private static readonly Plugins.Logs Log = new Plugins.Logs("FBI");
        ...
        private void fbiShape_onEntityEnterColShape(ColShape shape, Player entity)
        {
            ...
            catch (Exception ex) { Log.Write("fbiShape_onEntityEnterColShape: " + ex.Message, Plugins.Logs.Type.Error); }
        }
        ...
        private void fbiShape_onEntityExitColShape(ColShape shape, Player entity)
        {
            ...
            catch (Exception ex) { Log.Write("fbiShape_onEntityExitColShape: " + ex.Message, Plugins.Logs.Type.Error); }
        }
        ...
        public static void callback_fbilift(Player client, int floor)
        {
            ...
            catch (Exception e) { Log.Write("fbilift: " + e.Message, Plugins.Logs.Type.Error); }
        }
        ...
        public static void callback_fbiguns(Player client, int index)
        {
            ...
            catch (Exception e) { Log.Write("Fbigun: " + e.Message, Plugins.Logs.Type.Error); }
        }
        #endregion
    }
}
