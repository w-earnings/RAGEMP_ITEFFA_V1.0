    ...
    if (id == "exit_menu") {
        ...
        if (id == "home") {
            ...
            if (lscPage == "numbers_menu") {
                ...
                if (lscPage == "turbo_menu") localplayer.vehicle.toggleMod(18, false);
                ...
                } else if (lscPage == "wheels_menu") localplayer.vehicle.setWheelType(lscSettedWheelType);
            ...
            if (id == "numbers_menu") {
                ...
                if (lscPage == "home") {
                    ...
                    } else if (id == "wheels_menu") lscSettedWheelType = localplayer.vehicle.getWheelType();
            ...
            if (categoryIds[id] <= 9) {
                ...
                if (tuningConf[carName][categoryIds[id]] != undefined) {
                    ...
                    setTimeout(function () {
                        lsc.execute(`add(${JSON.stringify(elements)})`);
                    }, 150);
...
mp.events.add("thov", (id) => {
    ...
    if (lscPage == "numbers_menu") {
        ...
        if (categoryModsIds[lscPage] != undefined) {
            if (lscPage == "turbo_menu") localplayer.vehicle.toggleMod(18, true);
...
mp.events.add("tunbuy", (state) => {
    afkSecondsCount = 0;
    if (state) {
        if (wheelsTypes[lscPage] != undefined) mp.events.callRemote("buyTuning", 19, lscSelected, wheelsTypes[lscPage]);
...
mp.events.add("tunBuySuccess", (id) => {
    ...
    if (id != -2) {
        lscSettedMod = id;
        if (wheelsTypes[lscPage] != undefined) lscSettedWheelType = localplayer.vehicle.getWheelType();
        else if (lscPage == "paint_menu_one") {
            mp.events.call("showColorp");
            lscPrimary = localplayer.vehicle.getCustomPrimaryColour(1, 1, 1);
        } else if (lscPage == "paint_menu_two") {
